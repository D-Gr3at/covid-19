<?php
session_start();
$_SESSION['username'] = "admin@ndc.com";
?>
<!DOCTYPE html>
...
<body onload="tester()">
                                ...
                                <div class=" card shadow">
                                    <div class="card-body">
                                        <p>This is a covid-19 self assessment tool that it is not a diagnostic tool
                                            ...
                                            <br/>
                                            <b>Do you want to take a test or check statisitics of users?</b>
                                        </p>
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <button type="button" class="btn btn-primary btn-sm m-auto" data-dismiss="modal">take test</button>
                                            </div>
                                            <div class="col-sm-6">
    ...
    <div class="tab-pane d-none" id="login" role="tabpanel" aria-labelledby="login-tab">
        <div class="d-flex justify-content-center m-3">
            <div class="card shadow shadow-sm">
                <div class="card-body">
                    <center><img src="img/login.png" class="img-circle" style="border-radius: 50%;" width=100 height=100></center>
                    <h2 class="mb-4 text-center">USER LOGIN</h2>
                    <form method="post" action="utilities.php" id= "form2">
                        <div id="server-results" class="text-danger"></div>
                        <div class="form-group mb-3">
                            <label><b>Username:</b></label><br>
                            <input style="width: 300px;" type="text" id="username" name="username" class="form-control" placeholder="Enter Username">
                        </div>
                        <div class="form-group mb-3">
                            <label><b>Password:</b></label><br/>
                            <input style="width: 300px;" type="password" id="password" name="password" class="form-control" placeholder="Enter Password">
                        </div>
                        <div class="input-group mb-3">
    ...
    <script src="https://code.jquery.com/jquery-3.4.1.slim.min.js" integrity="sha384-J6qa4849blE2+poT4WnyKhv5vZF5SrPo0iEjwBvKU7imGFAV0wwj1yYfoRSJoZ+n"
        ...
        <script>
            ...
            const loginButton = document.getElementById('statistics');
